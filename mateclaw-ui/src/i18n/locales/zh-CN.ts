export default {
  ...
  login: {
    title: '登录',
    subtitle: '欢迎使用 Ozon-Claw 电商自动化平台',
    signIn: '登录',
    signingIn: '登录中...',
    signUp: '注册',
    placeholders: {
  ...
  register: {
    title: '注册',
    subtitle: '创建您的 Ozon-Claw 账号',
    signUp: '注册',
    registering: '注册中...',
    placeholders: {
      username: '请输入用户名（3-20位字母或数字）',
      email: '请输入邮箱',
      password: '请输入密码（至少6位）',
      confirmPassword: '请再次输入密码',
      inviteCode: '邀请码（可选）'
    },
    inviteCodeTip: '输入邀请码可获得额外奖励',
    ...
    errors: {
      ...
      agreeTermsRequired: '请阅读并同意服务条款和隐私政策'
    },
    termsContent: '服务条款内容...',
  ...
  store: {
    title: '店铺管理',
    description: '管理您的 Ozon 店铺，绑定 API 并同步数据',
    addStore: '添加店铺',
    addFirstStore: '添加您的第一个店铺',
    empty: '暂无店铺，点击添加',
    status: {
      all: '全部',
      active: '正常',
    ...
    syncSuccess: '数据同步成功',
    addSuccess: '店铺添加成功',
    deleteSuccess: '店铺删除成功',
    deleteConfirm: {
      title: '确认删除',
      message: '确定要删除店铺 "{name}" 吗？此操作不可恢复。'
    },
    // 利润配置
    profitConfig: {
      title: '利润配置',
      reset: '重置',
      saveSuccess: '利润配置保存成功',
      quickView: '利润率',
      targetRate: '目标利润率',
      sections: {
        basic: '基础配置',
      ...
      fields: {
        ...
        exchangeRate: '汇率 (CNY/RUB)',
        logisticsRate: '物流费率',
        platformCommission: '平台佣金'
      },
      hints: {
        minProfitRate: '商品最低利润率，低于此值将预警',
        targetProfitRate: '商品目标利润率，用于计算售价',
        exchangeRate: '人民币兑卢布汇率',
        logisticsRate: '物流成本占商品售价的百分比',
        platformCommission: 'Ozon 平台佣金百分比'
      },
      preview: {
        title: '价格预览',
        purchasePrice: '采购价',
        sellingPrice: '售价公式',
        estimatedPrice: '预估售价（100 CNY）'
      },
      errors: {
        minProfitRateRequired: '请输入最低利润率',
        targetProfitRateRequired: '请输入目标利润率',
        targetMustGreaterThanMin: '目标利润率必须大于最低利润率',
        exchangeRateRequired: '请输入汇率',
        logisticsRateRequired: '请输入物流费率',
        platformCommissionRequired: '请输入平台佣金'
      }
    },
    form: {
      storeName: '店铺名称',
      ...
      storeId: '店铺ID',
      storeIdPlaceholder: '请输入Ozon店铺ID',
      apiKey: 'API密钥',
      apiKeyPlaceholder: '请输入API密钥',
      clientId: 'Client ID',
      clientIdPlaceholder: '请输入Client ID',
      bindOzonAccount: '绑定您的 Ozon 卖家账户',
      bindHint: '请按以下步骤获取 API 凭证：',
      step1: '登录 Ozon Seller 后台',
      step2: '进入"设置" → "API密钥"页面',
      step3: '复制 Client ID 和 API Key 并填入上方表单',
      openOzonSeller: '打开 Ozon Seller'
    },
    errors: {
      loadFailed: '加载店铺列表失败',
      storeNameRequired: '请输入店铺名称',
      storeIdRequired: '请输入店铺ID',
  ...
  product: {
    title: '商品管理',
    description: '管理您的 Ozon 商品，批量上架和编辑',
    addProduct: '添加商品',
    selected: '已选择 {count} 个商品',
    filter: {
      selectStore: '选择店铺',
      selectStatus: '选择状态',
      selectCategory: '选择类目',
    ...
    batch: {
      ...
      unpublish: '批量下架',
      delete: '批量删除',
      publishSuccess: '已上架 {count} 个商品',
      unpublishSuccess: '已下架 {count} 个商品',
      deleteSuccess: '已删除 {count} 个商品',
      deleteConfirm: {
        title: '确认批量删除',
  ...
  recharge: {
    ...
    viewHistory: '查看充值记录',
    newOrder: '重新下单',
    orderCreated: '订单已生成，请扫码支付',
    orderCancelled: '订单已取消',
    paymentSuccessNotify: '充值成功！',
    status: {
      pending: '待支付',
      paid: '已支付',
      expired: '已过期',
    ...
    tip: {
      1: '充值比例 1:1，充值的配额将直接到账',
      2: '充值满200元赠送5%配额，满500元赠送10%，满1000元赠送15%',
      3: '支付二维码有效期为30分钟，请及时支付'
    },
    history: {
      title: '充值记录',
      description: '查看所有充值历史',
      totalRecharge: '累计充值',
      successCount: '成功次数',
      pendingCount: '待支付',
      filter: {
