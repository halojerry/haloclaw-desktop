export default {
  ...
  nav: {
    ...
    ozonDashboard: 'Dashboard',
    ozonStores: 'Store Management',
    ozonProducts: 'Product Management',
    ozonOrders: 'Order Management',
    ozonSelection: 'Selection Tool',
    recharge: 'Recharge',
  ...
  login: {
    title: 'Login',
    subtitle: 'Welcome to Ozon-Claw E-commerce Automation Platform',
    signIn: 'Sign In',
    ...
    noDeviceId: 'No device bound',
    manageDevices: 'Manage Devices',
    loginSuccess: 'Login successful',
    forgotPasswordHint: 'Please contact admin to reset password',
    errors: {
  ...
  register: {
    title: 'Register',
    subtitle: 'Create your Ozon-Claw account',
    signUp: 'Sign Up',
    ...
    inviteCodeTip: 'Enter invite code to get bonus',
    ...
    errors: {
      ...
      agreeTermsRequired: 'Please accept terms and privacy policy'
    },
  ...
  store: {
    ...
    description: 'Manage your Ozon stores, bind APIs and sync data',
    addStore: 'Add Store',
    addFirstStore: 'Add your first store',
    empty: 'No stores yet, click to add',
    status: {
      all: 'All',
      active: 'Active',
      expired: 'Expired',
    ...
    deleteConfirm: {
      ...
      message: 'Are you sure you want to delete store "{name}"? This cannot be undone.'
    },
    // Profit Config
    profitConfig: {
      title: 'Profit Configuration',
      reset: 'Reset',
      saveSuccess: 'Profit config saved successfully',
      quickView: 'Profit Rate',
      targetRate: 'Target Profit Rate',
      sections: {
        basic: 'Basic Settings',
        cost: 'Cost Settings'
      },
      fields: {
        minProfitRate: 'Minimum Profit Rate',
        targetProfitRate: 'Target Profit Rate',
        exchangeRate: 'Exchange Rate (CNY/RUB)',
        logisticsRate: 'Logistics Rate',
        platformCommission: 'Platform Commission'
      },
      hints: {
        minProfitRate: 'Minimum profit rate for products, alerts below this threshold',
        targetProfitRate: 'Target profit rate for products, used to calculate selling price',
        exchangeRate: 'CNY to RUB exchange rate',
        logisticsRate: 'Logistics cost as percentage of selling price',
        platformCommission: 'Ozon platform commission percentage'
      },
      preview: {
        title: 'Price Preview',
        purchasePrice: 'Purchase Price',
        sellingPrice: 'Selling Price Formula',
        estimatedPrice: 'Estimated Price (100 CNY)'
      },
      errors: {
        minProfitRateRequired: 'Please enter minimum profit rate',
        targetProfitRateRequired: 'Please enter target profit rate',
        targetMustGreaterThanMin: 'Target profit rate must be greater than minimum',
        exchangeRateRequired: 'Please enter exchange rate',
        logisticsRateRequired: 'Please enter logistics rate',
        platformCommissionRequired: 'Please enter platform commission'
      }
    },
    form: {
      ...
      storeId: 'Store ID',
      storeIdPlaceholder: 'Enter Ozon store ID',
      apiKey: 'API Key',
      apiKeyPlaceholder: 'Enter API key',
      clientId: 'Client ID',
      clientIdPlaceholder: 'Enter Client ID',
      bindOzonAccount: 'Bind your Ozon Seller account',
      bindHint: 'Follow these steps to get API credentials:',
      step1: 'Log in to Ozon Seller dashboard',
      step2: 'Go to "Settings" → "API Keys"',
      step3: 'Copy Client ID and API Key to the form above',
      openOzonSeller: 'Open Ozon Seller'
    },
    errors: {
      loadFailed: 'Failed to load stores',
      storeNameRequired: 'Please enter store name',
      storeIdRequired: 'Please enter store ID',
  ...
  product: {
    ...
    description: 'Manage your Ozon products, bulk listing and editing',
    ...
    batch: {
      ...
      publishSuccess: '{count} products published',
      unpublishSuccess: '{count} products unpublished',
      deleteSuccess: '{count} products deleted',
      deleteConfirm: {
        title: 'Confirm Bulk Delete',
        message: 'Are you sure you want to delete {count} selected products? This cannot be undone.'
      }
    },
    detail: {
  ...
  recharge: {
    title: 'Recharge',
    description: 'Recharge your account to get more quota',
    currentBalance: 'Current Balance',
    quota: 'Quota',
    refresh: 'Refresh',
    selectAmount: 'Select Amount',
    customAmount: 'Custom Amount',
    customPlaceholder: 'Enter recharge amount',
    bonus: 'Bonus',
    paymentMethod: 'Payment Method',
    selectAmountToPay: 'Select an amount to pay',
    rechargeAmount: 'Recharge Amount',
    totalGet: 'You Will Get',
    createOrder: 'Generate QR Code',
    ...
    newOrder: 'New Order',
    orderCreated: 'Order created, please scan QR code to pay',
    orderCancelled: 'Order cancelled',
    paymentSuccessNotify: 'Recharge successful!',
    status: {
      pending: 'Pending',
      paid: 'Paid',
      expired: 'Expired',
    ...
    tip: {
      1: 'Recharge ratio 1:1, quota will be credited immediately',
      2: 'Recharge 200+ gets 5% bonus, 500+ gets 10%, 1000+ gets 15%',
      3: 'QR code expires in 30 minutes, please pay in time'
    },
    history: {
      title: 'Recharge History',
      description: 'View all recharge records',
      ...
      continuePayHint: 'Redirecting to recharge page...',
      orderDetail: 'Order Details',
      errors: {
        loadFailed: 'Failed to load recharge history'
      }
    },
    errors: {
      loadBalanceFailed: 'Failed to load balance',
      selectAmount: 'Please select or enter amount',
